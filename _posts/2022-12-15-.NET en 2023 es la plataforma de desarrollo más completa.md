...
**NET 7** tiene mejoras en el rendimiento y nuevas características introducidas en **C#** 11, **F#** 7, **.NET MAUI**, **ASP.NET Core/Blazor**, **Web APIs**, **WinForms** y **WPF**.
...
6.  **IoT (Internet of Things)**: Compilar **aplicaciones IoT** con **C# y .NET** que se ejecutan en **Raspberry Pi**, HummingBoard, BeagleBoard, Pine A64, y más. (micro computadoras que puedes usar para encender o apagar dispositivos electronicos en todo tu hogar, o incluso construir algo más elaborado con sensores y mecanismos de hardware especializados).
   
7.  **Artificial Intelligence**: Aprende sobre redes neuronales y procesamiento del lenguaje natural con **ML.NET**. Ahora incluye una API de clasificación de texto que facilita el entrenamiento de modelos de clasificación de texto personalizados mediante las **últimas técnicas de aprendizaje profundo** de última generación.
...
Como ya mencioné arriba, **.NET 7** es una plataforma multilenguaje, por lo que puedes construir soluciones tanto en **Visual Basic**, como en **F#**, **C++** y **C#**.
